...
module.exports = {
  ...
  networks: {
    ...
    mumbai: {
      ...
      url: "https://speedy-nodes-nyc.moralis.io/9ff78c945ff569ea87f20274/polygon/mumbai", // <---- YOUR MORALIS ID! (not limited to infura)
      //gasPrice: 1000000000,
      gasPrice: 3000000000,
      accounts: {
        mnemonic: mnemonic(),
  ...
  etherscan: {
    apiKey: "S74KD3PYP4U91D886UPDDD8TR1V9UJ7UIE",
  },
};
